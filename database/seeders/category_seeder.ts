...
export default class extends BaseSeeder {
  async run() {
    ...
    const mainCategories = [
      {
        ...
        slug: 'pod-system',
        description:
          'Perangkat vape portabel dengan sistem pod yang mudah digunakan, cocok untuk pemula dan pengguna yang menginginkan kepraktisan.',
      ...
      },
      {
        ...
        slug: 'mod-kit',
        description:
          'Box mod dan starter kit lengkap untuk pengalaman vaping yang lebih advanced dengan fitur pengaturan power dan temperature control.',
      ...
      },
      {
        ...
        slug: 'liquid-premium',
        description:
          'E-liquid premium freebase dengan berbagai pilihan rasa dan level nikotin untuk mod dan RDA/RTA.',
      ...
      },
      {
        ...
        slug: 'salt-nicotine',
        description:
          'E-liquid salt nicotine dengan tingkat nikotin tinggi, sensasi throat hit yang halus, ideal untuk pod system.',
      ...
      },
      {
        ...
        slug: 'atomizer-coil',
        description:
          'RDA, RTA, RDTA, dan berbagai jenis coil/kawat untuk kebutuhan rebuildable atomizer.',
      ...
      },
      {
        ...
        slug: 'accessories',
        description:
          'Aksesoris vape termasuk baterai, charger, cotton, tool kit, dan perlengkapan lainnya.',
      ...
      },
      {
        ...
        slug: 'disposable',
        description:
          'Vape sekali pakai dengan berbagai rasa, praktis tanpa perlu isi ulang atau charging.',
    ...
    for (const category of mainCategories) {
      const created = await Category.updateOrCreate(
        { slug: category.slug },
        {
          name: category.name,
          slug: category.slug,
