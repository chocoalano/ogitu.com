...
import Article, { type ArticleCategory, type ArticleStatus } from '#models/article'
...
function createBlock(type: string, data: Record<string, unknown>): ContentBlock {
  return {
    id: generateBlockId(),
    type,
    data,
...
export default class ArticleSeeder extends BaseSeeder {
  async run() {
    ...
    const articles: ArticleSeedData[] = [
      // Article 1: Tips & Trik - Pod System Guide
      {
        title: 'Cara Memilih Pod System yang Tepat untuk Pemula',
        slug: 'cara-memilih-pod-system-untuk-pemula',
        excerpt:
          'Panduan lengkap memilih pod system pertama Anda. Dari kapasitas baterai hingga jenis coil yang cocok untuk pemula.',
        blocks: [
          ...
          createBlock('cta-box', {
            ...
            description:
              'Tim kami siap membantu Anda menemukan pod system yang tepat sesuai kebutuhan.',
      ...
      // Article 2: Review
      {
        ...
        excerpt:
          'Review mendalam Vaporesso XROS 3 dengan fitur adjustable airflow dan baterai 1000mAh. Apakah layak dibeli?',
        blocks: [
          ...
          createBlock('rating-box', {
            ...
            verdict:
              'Vaporesso XROS 3 adalah pilihan excellent untuk pemula maupun veteran. Adjustable airflow dan baterai besar menjadi nilai plus.',
            style: 'detailed',
          }),
      ...
      // Article 3: News
      {
        ...
        excerpt:
          'Update terbaru mengenai regulasi vape di Indonesia. Cukai, batasan usia, dan aturan penjualan online.',
        blocks: [
            ...
            items: [
              {
                ...
                content:
                  'Ya, vape legal di Indonesia dengan syarat produk memiliki pita cukai yang sah dan dijual kepada konsumen berusia minimal 18 tahun.',
              },
              {
                title: 'Bagaimana cara mengecek keaslian pita cukai?',
                content:
                  'Anda bisa mengecek keaslian pita cukai melalui aplikasi resmi Bea Cukai atau website cukai.kemenkeu.go.id dengan memasukkan kode yang tertera pada pita.',
              },
              {
                title: 'Apakah bisa membawa vape ke luar negeri?',
                content:
                  'Peraturan berbeda di setiap negara. Beberapa negara seperti Singapura dan Thailand melarang total kepemilikan vape. Selalu cek regulasi negara tujuan sebelum bepergian.',
              },
            ],
            allowMultiple: true,
            style: 'bordered',
          ...
          createBlock('newsletter', {
            ...
            description:
              'Subscribe newsletter kami untuk mendapatkan informasi regulasi dan berita vape terkini.',
      ...
      // Article 4: Guide
      {
        ...
        excerpt:
          'Pelajari dasar-dasar coil building dari nol. Termasuk tools yang dibutuhkan, jenis wire, dan step-by-step tutorial.',
        blocks: [
...
P = Power (Watt)`,
          ...
          createBlock('cta-box', {
            ...
            description:
              'Kami menyediakan berbagai wire, cotton, dan tools untuk coil building dengan harga terbaik.',
      ...
      // Article 5: Promo
      {
        ...
        excerpt:
          'Promo spesial Ramadhan! Dapatkan diskon hingga 50% untuk berbagai produk vape pilihan. Periode terbatas!',
        blocks: [
          createBlock('heading', {
      ...
      // Article 6: Tips - Maintenance
      {
        title: 'Cara Merawat Pod System Agar Awet dan Tahan Lama',
        slug: 'cara-merawat-pod-system',
        excerpt:
          'Tips perawatan pod system yang benar untuk memperpanjang umur perangkat dan menjaga performa optimal.',
        blocks: [
      ...
      // Article 7: Guide - Nicotine Salt
      {
        title: 'Apa Itu Nicotine Salt? Perbedaan dengan Freebase Nicotine',
        slug: 'nicotine-salt-vs-freebase',
        excerpt:
          'Penjelasan lengkap tentang nicotine salt, perbedaannya dengan freebase, dan mana yang cocok untuk Anda.',
        blocks: [
