...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.decimal('commission_rate', 5, 2).defaultTo(5.0).notNullable() // 5% default commission
      ...
      table.integer('total_orders').defaultTo(0).notNullable() // Orders from referrals
