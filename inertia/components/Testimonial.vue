...
<template>
  <div class="flex flex-col gap-4 w-full">
    <USeparator orientation="horizontal" class="h-48" />
    <div class="text-center mb-12 lg:mb-16 scroll-reveal">
        <h2 class="text-3xl lg:text-5xl font-black text-gray-900 dark:text-white mb-4">
          ...
          <span class="bg-linear-to-r from-primary-600 via-secondary-600 to-cyan-600 dark:from-primary-400 dark:via-secondary-400 dark:to-cyan-400 text-transparent bg-clip-text">ogitu.com</span>?
        </h2>
        <p class="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
          Dapatkan pengalaman belanja vape terbaik dengan jaminan kepuasan pelanggan
        </p>
      </div>
    <UMarquee
      pause-on-hover
