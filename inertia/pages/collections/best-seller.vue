...
<template>
  <Head>
    ...
    <link rel="canonical" :href="`${siteUrl}/best-seller`" />
    <meta property="og:title" :content="pageTitle" />
    <meta property="og:description" :content="pageDescription" />
    <meta property="og:type" content="website" />
    <meta property="og:url" :content="`${siteUrl}/best-seller`" />
  </Head>
  ...
  <div class="min-h-screen bg-linear-to-b from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900">
    ...
    <div class="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      <div class="absolute top-0 left-1/4 w-125 h-125 bg-orange-500/10 rounded-full blur-3xl" />
      <div class="absolute top-1/3 right-1/4 w-100 h-100 bg-red-500/10 rounded-full blur-3xl" />
      <div class="absolute bottom-1/4 left-1/2 w-150 h-75 bg-yellow-500/5 rounded-full blur-3xl" />
    </div>

    <!-- Hero Section -->
    <div class="relative bg-linear-to-r from-orange-500 via-red-500 to-pink-500 overflow-hidden">
      <!-- Pattern Overlay -->
      <div class="absolute inset-0 opacity-10">
        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="fire-pattern" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <nav class="flex items-center gap-2 text-sm mb-6 text-white/80">
          ...
          <span class="text-white font-medium">Best Seller</span>
        </nav>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            <div class="flex items-center gap-4 mb-4">
              <div class="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center">
                <UIcon name="i-heroicons-fire" class="w-8 h-8 text-white" />
              </div>
              <div>
                <h1 class="text-3xl sm:text-4xl font-bold text-white">Best Seller</h1>
                <p class="text-white/80 mt-1">Produk Terlaris Pilihan Vapers</p>
              </div>
            </div>
            <p class="text-white/70 max-w-xl">
              Temukan produk vape yang paling banyak dibeli dan dipercaya oleh ribuan customer. Kualitas terjamin, harga terbaik!
            </p>
          </div>
          ...
          <div class="flex gap-6">
            <div class="text-center">
              ...
              <p class="text-sm text-white/70">Produk Terlaris</p>
            </div>
            <div class="text-center">
              <p class="text-3xl font-bold text-white">50K+</p>
              <p class="text-sm text-white/70">Terjual</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div v-else class="text-center py-16">
        <div class="w-24 h-24 mx-auto mb-6 rounded-3xl bg-orange-500/10 flex items-center justify-center">
          <UIcon name="i-heroicons-fire" class="w-12 h-12 text-orange-500" />
        </div>
        <h2 class="text-xl font-bold text-gray-900 dark:text-white mb-2">Belum Ada Produk</h2>
        <p class="text-gray-500 dark:text-gray-400 mb-6">Coba ubah filter untuk menemukan produk best seller.</p>
    ...
    <div class="bg-white dark:bg-gray-800/50 border-y border-gray-200 dark:border-gray-700">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white text-center mb-8">
          Kenapa Pilih Produk Best Seller?
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="text-center p-6">
            <div class="w-14 h-14 mx-auto mb-4 rounded-2xl bg-orange-500/10 flex items-center justify-center">
              <UIcon name="i-heroicons-star" class="w-7 h-7 text-orange-500" />
            </div>
            <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Terbukti Berkualitas</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Dipilih dan direview positif oleh ribuan customer satisfied
            </p>
          </div>
          <div class="text-center p-6">
            <div class="w-14 h-14 mx-auto mb-4 rounded-2xl bg-red-500/10 flex items-center justify-center">
              <UIcon name="i-heroicons-shield-check" class="w-7 h-7 text-red-500" />
            </div>
            <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Garansi Original</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">
              100% produk original dengan garansi resmi dari brand
            </p>
          </div>
          <div class="text-center p-6">
            <div class="w-14 h-14 mx-auto mb-4 rounded-2xl bg-yellow-500/10 flex items-center justify-center">
              <UIcon name="i-heroicons-truck" class="w-7 h-7 text-yellow-500" />
            </div>
            <h3 class="font-semibold text-gray-900 dark:text-white mb-2">Fast Delivery</h3>
            <p class="text-sm text-gray-500 dark:text-gray-400">
              Stok selalu ready, pengiriman cepat ke seluruh Indonesia
            </p>
          </div>
        </div>
      </div>
