...
export default class extends BaseSchema {
    ...
    async up() {
        this.schema.createTable(this.tableName, (table) => {
            ...
            table.integer('min_spent').defaultTo(0).notNullable();
            table.decimal('cashback_rate', 5, 2).defaultTo(0).notNullable();
            table.decimal('affiliate_bonus_rate', 5, 2).defaultTo(0).notNullable();
...
//# sourceMappingURL=1765600000006_create_customer_ranks_table.js.map