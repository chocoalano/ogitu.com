...
export default class OrderRepository {
    ...
    async findByIdAndCustomer(orderId, customerId) {
        return Order.query()
            .where('id', orderId)
    ...
    async cancelOrder(orderId, customerId) {
        ...
        if (order.status !== 'pending_payment') {
            return {
                success: false,
                message: 'Order tidak dapat dibatalkan. Hanya pesanan dengan status "Menunggu Pembayaran" yang dapat dibatalkan.',
            };
        }
    ...
    async confirmReceived(orderId, customerId) {
