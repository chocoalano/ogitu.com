...
import { _ as _sfc_main$3 } from './AddressForm-BZuIfNSs.js';
import 'reka-ui';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Tambah Alamat" }, null, _parent));
      ...
      _push(`<div><h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Alamat</h1><p class="mt-1 text-sm text-gray-500 dark:text-gray-400"> Tambahkan alamat gudang/toko baru </p></div></div><!-- Form -->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("inertia/pages/admin/settings/address/create.vue");
