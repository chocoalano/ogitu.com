...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 px-4" }, _attrs))}><div class="text-center"><p class="text-9xl font-bold text-primary-500">404</p><h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-5xl"> Halaman tidak ditemukan </h1><p class="mt-6 text-base leading-7 text-gray-600 dark:text-gray-400"> Halaman yang Anda cari tidak tersedia atau telah dipindahkan. </p><div class="mt-10">`);
