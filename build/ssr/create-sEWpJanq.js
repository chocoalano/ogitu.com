import { _ as _sfc_main$1, a as _sfc_main$4 } from './Button-BBveOjhJ.js';
import { _ as _sfc_main$3 } from './Select-1_-G9zx4.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Pengguna</h1><p class="text-gray-500 dark:text-gray-400"> Tambah pengguna admin baru </p></div></div><!-- Form --><div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6"><form class="space-y-6"><!-- Full Name --><div><label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2"> Nama Lengkap <span class="text-red-500">*</span></label>`);
      ...
      _push(ssrRenderComponent(_component_UButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Simpan Pengguna `);
          } else {
            return [
              createTextVNode(" Simpan Pengguna ")
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("inertia/pages/admin/users/create.vue");
