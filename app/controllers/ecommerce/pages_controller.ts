...
export default class PagesController {
   ...
   * Help/FAQ page
   */
  public async help({ inertia }: HttpContext) {
    // FAQ data
    const faqs = [
      {
        category: 'Pemesanan',
        ...
        questions: [
          {
            ...
            answer:
              'Pilih produk yang diinginkan, tambahkan ke keranjang, lalu lanjutkan ke checkout. Isi alamat pengiriman dan pilih metode pembayaran.',
          },
          {
            question: 'Apakah bisa membatalkan pesanan?',
            answer:
              'Pesanan dapat dibatalkan selama status masih "Menunggu Pembayaran". Setelah pembayaran dikonfirmasi, pesanan tidak dapat dibatalkan.',
          },
          {
            question: 'Berapa minimal pembelian?',
            answer:
              'Tidak ada minimal pembelian. Anda bisa membeli 1 item saja. Namun, beberapa produk mungkin memiliki minimal order tertentu.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            answer:
              'Kami menerima pembayaran via Bank Transfer (BCA, Mandiri, BNI, BRI), E-Wallet (GoPay, OVO, DANA), dan QRIS.',
          },
          {
            question: 'Berapa lama batas waktu pembayaran?',
            answer:
              'Batas waktu pembayaran adalah 24 jam setelah pesanan dibuat. Pesanan akan otomatis dibatalkan jika tidak dibayar dalam waktu tersebut.',
          },
          {
            question: 'Apakah pembayaran aman?',
            answer:
              'Ya, semua transaksi diproses melalui payment gateway Midtrans yang sudah tersertifikasi PCI-DSS untuk keamanan maksimal.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            answer:
              'Kami bekerja sama dengan JNE, J&T, SiCepat, dan Anteraja untuk pengiriman ke seluruh Indonesia.',
          },
          {
            question: 'Berapa lama estimasi pengiriman?',
            answer:
              'Estimasi pengiriman tergantung lokasi dan ekspedisi yang dipilih. Umumnya 1-3 hari untuk Jabodetabek dan 3-7 hari untuk luar Jawa.',
          },
          {
            question: 'Bagaimana cara melacak pesanan?',
            answer:
              'Gunakan halaman "Track Order" dengan memasukkan nomor pesanan. Anda juga akan mendapat notifikasi setiap ada update status.',
          },
          {
            question: 'Apakah ada gratis ongkir?',
            answer:
              'Ya! Kami sering mengadakan promo gratis ongkir. Cek halaman promo atau ikuti social media kami untuk info terbaru.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            answer:
              '100% produk yang kami jual adalah original dan bergaransi resmi. Kami hanya bekerja sama dengan distributor resmi.',
          },
          {
            question: 'Bagaimana jika produk rusak/cacat?',
            answer:
              'Hubungi customer service dalam 1x24 jam setelah barang diterima dengan menyertakan foto/video. Kami akan proses pengembalian atau penggantian.',
          },
          {
            question: 'Berapa lama garansi produk?',
            answer:
              'Garansi berbeda-beda tergantung produk. Device umumnya 3-6 bulan, sedangkan liquid tidak ada garansi karena sifatnya consumable.',
          },
        ],
      },
      {
        ...
        questions: [
          {
            ...
            answer:
              'Dengan akun, Anda bisa menyimpan alamat, melihat riwayat pesanan, mengumpulkan poin, dan mendapat akses promo eksklusif.',
          },
          {
            question: 'Bagaimana sistem ranking member?',
            answer:
              'Ranking member ditentukan dari total belanja dan jumlah transaksi. Semakin tinggi rank, semakin besar diskon dan benefit yang didapat.',
          },
          {
            question: 'Bagaimana cara jadi affiliate?',
            answer:
              'Setelah membuat akun, Anda otomatis mendapat kode referral. Bagikan kode tersebut dan dapatkan komisi dari setiap pembelian.',
          },
        ],
      },
    ]
   ...
   */
  public async shipping({ inertia }: HttpContext) {
    const shippingInfo = {
      couriers: [
        {
          name: 'JNE',
   ...
   */
  public async payment({ inertia }: HttpContext) {
   ...
   */
  public async returns({ inertia }: HttpContext) {
    const returnsPolicy = {
      conditions: [
        {
  ...
  public async contact({ inertia }: HttpContext) {
    const contactInfo = {
      ...
      office: {
        ...
        country: 'Indonesia',
        mapEmbed:
          'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.0!2d106.8!3d-6.2!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNsKwMTInMDAuMCJTIDEwNsKwNDgnMDAuMCJF!5e0!3m2!1sen!2sid!4v1234567890',
      },
      workingHours: {
   ...
   * About us page
   */
  public async about({ inertia }: HttpContext) {
    const aboutData = {
      company: {
        name: 'Ogitu',
        ...
        founded: '2020',
        description:
          'Ogitu adalah toko vape online terpercaya di Indonesia yang menyediakan berbagai produk vape original dengan kualitas premium. Kami berkomitmen untuk memberikan pengalaman berbelanja terbaik dengan produk 100% original dan layanan pelanggan yang responsif.',
      },
      stats: [
   ...
   * Blog page
   */
  public async blog({ inertia }: HttpContext) {
    ...
    const blogData = {
      featured: {
        ...
        excerpt:
          'Bingung memilih pod system pertama? Simak panduan lengkap ini untuk menemukan device yang tepat sesuai kebutuhan Anda.',
   ...
   * Careers page
   */
  public async careers({ inertia }: HttpContext) {
    const careersData = {
      intro: {
        title: 'Bergabung dengan Tim Ogitu',
        description:
          'Kami selalu mencari talenta terbaik untuk bergabung dalam misi kami menyediakan produk vape berkualitas untuk seluruh Indonesia. Jika Anda passionate dengan dunia vape dan e-commerce, mari bergabung!',
      },
      benefits: [
   ...
   * Press release page
   */
  public async press({ inertia }: HttpContext) {
    const pressData = {
      intro: {
        title: 'Press & Media',
        description:
          'Temukan berita terbaru, press release, dan media kit Ogitu. Untuk pertanyaan media, silakan hubungi tim PR kami.',
        contact: {
      ...
      releases: [
        {
          ...
          date: '1 Des 2024',
          excerpt:
            'Ogitu dinobatkan sebagai Best Vape Store oleh Indonesian Vape Association dalam ajang tahunan IVA Awards 2024.',
        ...
        },
        {
          ...
          date: '15 Nov 2024',
          excerpt:
            'Ogitu resmi menjadi authorized distributor SMOK untuk Indonesia, memperluas akses produk premium.',
        ...
        },
        {
          ...
          date: '1 Okt 2024',
          excerpt:
            'Dengan ekspansi gudang ke 10 kota besar, Ogitu kini mampu melayani pengiriman lebih cepat.',
   ...
   */
  public async affiliate({ inertia }: HttpContext) {
    const affiliateData = {
      hero: {
      ...
      faq: [
        {
          ...
          answer:
            'Semua member yang sudah terdaftar bisa langsung ikut program afiliasi. Tidak ada syarat khusus.',
        },
        {
          question: 'Berapa lama cookie tracking berlaku?',
          answer:
            'Cookie tracking berlaku 30 hari. Artinya jika seseorang klik link Anda hari ini dan beli dalam 30 hari, Anda tetap dapat komisi.',
        },
        {
          question: 'Kapan komisi bisa dicairkan?',
          answer:
            'Komisi masuk ke wallet setelah pesanan selesai (delivered). Bisa dicairkan kapan saja dengan minimum Rp 50.000.',
        },
        {
          question: 'Apakah ada batasan penghasilan?',
          answer:
            'Tidak ada batasan! Semakin banyak referral yang membeli, semakin besar penghasilan Anda.',
        },
      ],
      testimonials: [
        {
