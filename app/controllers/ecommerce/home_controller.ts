...
export default class HomeController {
  ...
  async index({ inertia }: HttpContext) {
    ...
    const [categories, featuredProducts, bestSellerProducts, brands, customerRanks] =
      await Promise.all([
   ...
   */
  private async getCachedFeaturedProducts() {
  ...
  /**
   * Get best sellers with cache
   */
  private async getCachedBestSellers() {
  ...
  /**
   * Get brands with cache
   */
  private async getCachedBrands() {
  ...
  /**
   * Get customer ranks with cache
   */
  private async getCachedCustomerRanks() {
  ...
  /**
   * Get default rank icon based on index
   */
  private getDefaultRankIcon(index: number): string {
